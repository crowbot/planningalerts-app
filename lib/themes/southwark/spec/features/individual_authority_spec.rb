...
feature "southwark individual authority page" do
  ...
  scenario "it should have a section to select an authority from a dropdown list" do
    ...
    visit authority_url(:id => "test1", :host => "southwark.127.0.0.1.xip.io:3000")
  ...
  scenario "should list all the applications for the authority" do
    ...
    visit authority_url(:id => "test", :host => "southwark.127.0.0.1.xip.io:3000")
