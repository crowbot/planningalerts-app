...
feature "southwark theme home page" do
  context "in general" do
    scenario "Visiting the home page" do
      VCR.use_cassette('southwark_theme_homepage', :record => :once, :allow_playback_repeats => true) do
        visit root_url(:host => "southwark.127.0.0.1.xip.io:3000")
      end
  ...
  context "search validation" do
    ...
    scenario "Submitting an invalid postcode" do
      VCR.use_cassette('southwark_theme_invalid_postcode', :record => :once, :allow_playback_repeats => true) do
        visit root_url(:host => "southwark.127.0.0.1.xip.io:3000")
    ...
    scenario "Submitting an invalid address" do
      VCR.use_cassette('southwark_theme_invalid_address', :record => :once, :allow_playback_repeats => true) do
        visit root_url(:host => "southwark.127.0.0.1.xip.io:3000")
